...
namespace WinFormsApp5
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            Player player1 = new Player { Id = 1, TeamName = "Барселона", Country = "Швейцарія", NameSurname = "Марк-Андре тер Стеген", Number = 1, Position = "Воротар" };
            Player player2 = new Player { Id = 2, TeamName = "Барселона", Country = "Іспанія", NameSurname = "Пабло Мартін Паєс Гавіра", Number = 6, Position = "Півзахисник" };
            Player player3 = new Player { Id = 3, TeamName = "Барселона", Country = "Іспанія", NameSurname = "Сергіо Роберто", Number = 20, Position = "Захисник" };
            ...
            Player player8 = new Player { Id = 8, TeamName = "Реал Мадрид", Country = "Швейцарія", NameSurname = "Едуардо Камавінга", Number = 12, Position = "Півзахисник" };
            Player player9 = new Player { Id = 9, TeamName = "Реал Мадрид", Country = "Туреччина", NameSurname = "Начо Фернандез", Number = 6, Position = "Захисник" };
